...
Label laxis;
laxis.p = fontsize(12);
xaxis(Label("$t$/s", embed=Shift, align=4*E),xmin, xmax,defaultpen+black+linewidth(1.2), Ticks(laxis, ticklabel=null, Step = 1.000000000000000, Size = 2), Arrow(6), above = true); 
yaxis(rotate(0)*Label("$\vec{s}$/m",align=3*N), ymin, ymax,defaultpen+black+linewidth(1.2), Ticks(laxis, ticklabel=null, Step = 1.000000000000000, Size = 2), Arrow(6), above = true); /* draws axes; NoZero hides '0' label */ 
 /* draw figures */
